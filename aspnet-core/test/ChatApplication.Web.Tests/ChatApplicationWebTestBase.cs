...
{
    public abstract class ChatApplicationWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ChatApplicationWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ChatApplicationWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ChatApplicationDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ChatApplicationDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ChatApplicationDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ChatApplicationDbContext, Task<T>> func)
        {
            T result;
