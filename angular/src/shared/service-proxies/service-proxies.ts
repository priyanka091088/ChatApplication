...
export class ChatServiceProxy {
     ...
     * @return Success
     */
    create(body: ChatDTO | undefined): Observable<ChatDTO> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ChatDTO>><any>_observableThrow(e);
                }
            } else
                return <Observable<ChatDTO>><any>_observableThrow(response_);
        }));
    }

    protected processCreate(response: HttpResponseBase): Observable<ChatDTO> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return _observableOf<ChatDTO>(<any>null);
    }
     ...
     * @return Success
     */
    update(body: ChatDTO | undefined): Observable<ChatDTO> {
        let url_ = this.baseUrl + "/api/services/app/Chat/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<ChatDTO> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    get(id: number | undefined): Observable<ChatDTO> {
        let url_ = this.baseUrl + "/api/services/app/Chat/Get?";
        if (id === null)
    ...
    protected processGet(response: HttpResponseBase): Observable<ChatDTO> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getAll(sorting: string | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<ChatDTOPagedResultDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ChatDTOPagedResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<ChatDTOPagedResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<ChatDTOPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ChatDTOPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ChatDTOPagedResultDto>(<any>null);
    }
    ...
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Chat/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
...
export class ChatDTOPagedResultDto implements IChatDTOPagedResultDto {
    ...
    constructor(data?: IChatDTOPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ChatDTOPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new ChatDTOPagedResultDto();
        result.init(data);
        return result;
    }
...
export interface IChatDTOPagedResultDto {
    totalCount: number;
    items: ChatDTO[] | undefined;
}
